...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Data Penduduk Luar</h3>
        </div>
        <div class="card-toolbar justify-content-between ">
            ...
            <!--begin::Button-->
            <a href="/data-penduduk/penduduk-luar/create" class="btn btn-primary font-weight-bolder mt-md-5 mt-xl-0">
            <span class="svg-icon svg-icon-md">
...
<form action="/data-penduduk/penduduk-luar/download" class="export-form" method="POST" >
		...
		var createTable = function() {
			...
			var datatable = $('#kt_datatable').KTDatatable({
				...
				columns: [
				{
					...
					template: function(e) {
						return `\
							<a href="/data-penduduk/penduduk-luar/show/${e.id}" class="btn btn-sm btn-clean btn-icon mr-2 bg-light " title="Edit details">\
