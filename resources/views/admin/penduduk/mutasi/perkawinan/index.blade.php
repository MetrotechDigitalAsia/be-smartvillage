...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Data Penduduk (Kawin)</h3>
        </div>
        <div class="card-toolbar justify-content-between ">
			...
			<a href="/data-penduduk/penduduk/download/perkawinan" class="btn btn-light-primary font-weight-bolder mr-5" >
