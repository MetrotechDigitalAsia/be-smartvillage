				...
				columns: [
				{
					...
					template: function(e) {
						return `\
							...
							<a href="javascript:;" data-href="/data-penduduk/penduduk/mutasi/pindah-keluar/delete/${e.id}" onclick="deleteData(this)" class="btn btn-sm btn-clean btn-icon bg-light" title="Delete">\
