...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar justify-content-between ">
			...
			<a href="/data-penduduk/penduduk/download/meninggal" class="btn btn-light-primary font-weight-bolder mr-5 download-btn" >
            ...
            <!--begin::Button-->
            <a href="/data-penduduk/penduduk/mutasi/meninggal/create" class="btn btn-primary font-weight-bolder mt-md-5 mt-xl-0">
            <span class="svg-icon svg-icon-md">
...
<script>
	...
	function handleChangeRange(el){
		...
		if(el.value !== ''){
			downloadBtn.href = '/data-penduduk/penduduk/download/meninggal?time='+el.value
		} else {
			downloadBtn.href = '/data-penduduk/penduduk/download/meninggal'
		}
		...
		var createTable = function() {
			...
			var datatable = $('#kt_datatable').KTDatatable({
				...
				columns: [
				{
					...
					template: function(e) {
						return `\
							<a href="/data-penduduk/penduduk/mutasi/meninggal/show/${e.id}" class="btn btn-sm btn-clean btn-icon mr-2 bg-light " title="Edit details">\
							...
							<a href="javascript:;" data-href="/data-penduduk/penduduk/mutasi/meninggal/delete/${e.id}" onclick="deleteData(this)" class="btn btn-sm btn-clean btn-icon bg-light" title="Delete">\
			...
			$('#kt_datatable_search_banjar').on('change', function() {
				datatable.search($(this).val().toLowerCase(), 'time');
			});
