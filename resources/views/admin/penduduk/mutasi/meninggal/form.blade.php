...
@section('content')
        ...
        <div class="card-body">
            <div class="row justify-content-between">
                ...
                <div class="col col-lg-6">
                    ...
                    @livewire('mutation.resident-died-form', [
                        'data' => $residentDiedMutation ?? null
                    ])
    ...
    <script>
        ...
        @if(!empty($residentDiedMutation))
        document.addEventListener("DOMContentLoaded", () => {
            var residentDiedMutation = {{ Js::from($residentDiedMutation) }}
            console.log(residentDiedMutation)
            if(residentDiedMutation){
                Livewire.emit('selectResident', residentDiedMutation.resident_id)
            }
        });
        @endif
        ...
        Livewire.on('mutationSubmitted', data => {
            ...
            .then(() => {
                if(data.status)
                    window.location.href = '/data-penduduk/penduduk/mutasi/meninggal'
            })
        })
        ...
        function handleChangeResident(el){
            ...
            Livewire.emit('selectDiedResident', el.value)
