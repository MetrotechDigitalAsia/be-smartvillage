    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar justify-content-between ">
			...
			{{-- <div class="dropleft mr-5">
				...
				<!--begin::Dropdown Menu-->
				<div class="dropdown-menu dropdown-menu-sm dropdown-menu-anim-up dropdown-menu-right">
					<!--begin::Navigation-->
					<ul class="navi flex-column navi-hover py-2">
						<li class="navi-section text-muted font-weight-bolder pb-0">
							Excel
						</li>
						@foreach (['Kauh', 'Ubud', 'Buangga', 'Tengah'] as $item)
						<li class="navi-item">
							<a href="#" class="navi-link" data-offset="0,10" data-toggle="dropdown" >
								<span class="navi-icon">
									<i class="la la-file-invoice"></i>
								</span>
								<span class="navi-text">{{ $item }}</span>
							</a>
						</li>
						@endforeach
						<li class="navi-item">
						...
						@endforeach
						<li class="navi-item">
							<a href="/data-penduduk/penduduk/download/all" class="navi-link" >
								<span class="navi-icon">
									<i class="la la-file-invoice"></i>
								</span>
								<span class="navi-text">Semua</span>
