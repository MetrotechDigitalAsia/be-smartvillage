        ...
        <div class="card card-custom card-stretch">
            ...
            <div class="card-body px-5">
                ...
                <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                    ...
                    <div class="navi-item my-2">
                        <a href="/data-penduduk/keluarga" class="navi-link @if(Route::currentRouteName() == 'family') active @endif  ">
                            <span class="navi-icon mr-4">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Mail-heart.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="navi-text font-weight-bolder font-size-lg">Data keluarga</span>
                        </a>
                    </div>
                    <!--end:Item-->
                </div>
