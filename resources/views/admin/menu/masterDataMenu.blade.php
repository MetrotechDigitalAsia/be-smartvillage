            ...
            <div class="card-body px-5">
                ...
                <div class="navi navi-hover navi-active navi-link-rounded navi-bold navi-icon-center navi-light-icon">
                    ...
                    <div class="navi-item my-2">
                        <a href="/master-data/kategori-artikel" class="navi-link @if(Str::contains(Route::current()->uri, 'kategori-artikel')) active @endif  ">
                            ...
                            <span class="navi-text font-weight-bolder font-size-lg">Kategori Artikel</span>
                        </a>
                    </div>
                    <!--end:Item-->
                    <!--begin:Item-->
                    <div class="navi-item my-2">
                        <a href="/master-data/kategori-pengaduan" class="navi-link  @if(Str::contains(Route::current()->uri, 'kategori-pengaduan')) active @endif ">
                            <span class="navi-icon mr-4">
                                <span class="svg-icon svg-icon-lg">
                            ...
                            <span class="navi-text font-weight-bolder font-size-lg">Kategori Pengaduan</span>
                        </a>
                    </div>
                    <!--end:Item-->
                    <!--begin:Item-->
                    ...
                    <div class="navi-item my-2">
                        <a href="/master-data/position" class="navi-link @if(Str::contains(Route::current()->uri, 'position')) active @endif ">
                            <span class="navi-icon mr-4">
                                <span class="svg-icon svg-icon-lg">
                            ...
                            <span class="navi-text font-weight-bolder font-size-lg">Position</span>
                        </a>
                    </div>

                    <div class="navi-item my-2">
                        <a href="/master-data/staff" class="navi-link @if(Str::contains(Route::current()->uri, 'staff')) active @endif ">
                            <span class="navi-icon mr-4">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="navi-text font-weight-bolder font-size-lg">Staff</span>
                        </a>
                    </div>

                    <div class="navi-item my-2">
                        <a href="/master-data/kategori-umkm" class="navi-link @if(Str::contains(Route::current()->uri, 'kategori-umkm')) active @endif ">
                            <span class="navi-icon mr-4">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="navi-text font-weight-bolder font-size-lg">Kategori UMKM</span>
                        </a>
                    </div>

                    <div class="navi-item my-2">
                        <a href="/master-data/data-penduduk" class="navi-link @if(Str::contains(Route::current()->uri, 'data-penduduk')) active @endif ">
                            <span class="navi-icon mr-4">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                    ...
                    <div class="navi-item my-2">
                        <a href="/master-data/user-login" class="navi-link @if(Str::contains(Route::current()->uri, 'user-login')) active @endif ">
                            <span class="navi-icon mr-4">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="navi-text font-weight-bolder font-size-lg">User Login</span>
                        </a>
                    </div>

                    <div class="navi-item my-2">
                        <a href="/master-data/admin" class="navi-link @if(Str::contains(Route::current()->uri, 'admin')) active @endif ">
                            <span class="navi-icon mr-4">
                                <span class="svg-icon svg-icon-lg">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/PenAndRuller.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <span class="navi-text font-weight-bolder font-size-lg">Admin</span>
                        </a>
                    </div>
