...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        ...
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="/master-data/admin/create" class="btn btn-primary font-weight-bolder">
		...
		var createTable = function() {
			...
			var datatable = $('#kt_datatable').KTDatatable({
				...
				columns: [
				{
					...
					template: function(e) {
						return `\
							<a href="/master-data/admin/show/${e.uuid}" class="btn btn-sm btn-clean btn-icon mr-2 bg-light " title="Edit details">\
							...
							<a href="javascript:;" data-href="/master-data/admin/delete/${e.uuid}" onclick="deleteData(this)" class="btn btn-sm btn-clean btn-icon bg-light" title="Delete">\
