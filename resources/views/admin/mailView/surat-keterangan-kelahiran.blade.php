<h3 class="text-center" style="text-transform: uppercase;" >{{ $data->title }}</h3>
    ...
    <table class="align-self-start ml-10" >
        <tr>
            ...
            <td style="text-tansform: capitalize; !important" >: {{ $field->child_name }}</td>
        </tr>
        <tr>
            <td></td>
            <td>Jenis Kelamin</td>
        ...
        <tr>
            ...
            <td style="text-tansform: capitalize; !important" >: {{ $field->child_birthplace.', '. Carbon\Carbon::parse($field->child_birth_date)->translatedFormat('d F Y') }}</td>
        </tr>
        <tr>
            <td></td>
            <td>NIK</td>
