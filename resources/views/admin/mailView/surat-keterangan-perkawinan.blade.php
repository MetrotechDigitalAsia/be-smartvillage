...
<div class="mail-body" style="padding: 0 42px; padding-bottom: 100px;" >
    ...
    <p style="text-align: justify; font-size: 12px; text-indent: 0;" >Nama Istri : <span style="text-transform: capitalize;" >{{ $field->subject_2->name ?? '' }}</span> Agama Hindu, Tempat/ tanggal lahir : <span style="text-transform: capitalize;" >{{ $field->subject_2->birthplace ?? '' }}</span>, {{ !empty($field->subject_2->birthdate) ? Carbon\Carbon::parse($field->subject_2->birthdate)->format('d/m/Y') : '' }}, Pekerjaan <span style="text-transform: capitalize;" >{{ $field->subject_2->job ?? '' }}</span>, alamat tempat tinggal di : Banjar/Lingk : ubud ,Desa/Kelurahan Getasan Kecamatan Petang, Kabupaten/Kota Badung Provinsi Bali. Anak laki-laki dari: nama (ayah) <span style="text-transform: capitalize;" >{{ $field->subject_2_father_name }}</span> dan nama (ibu) <span style="text-transform: capitalize;" >{{ $field->subject_2_mother_name }}</span>  bertempat tinggal di : Banjar/Lingk : ubud ,Desa/Kelurahan Getasan Kecamatan Petang, Kabupaten/Kota Badung Provinsi Bali.</p>
    <p style="text-align: justify; font-size: 12px;margin: 0;" >Bahwa Atas dasar suka sama suka mereka telah melangsungkan tata cara perkawinan secara <br>agama Hindu di .........................., pada hari {{ !empty($field->marriage_date) ? Carbon\Carbon::parse($field->marriage_date)->translatedFormat('l') : '' }} tanggal : {{ Carbon\Carbon::parse($field->marriage_date)->translatedFormat('d/m/Y') }} , dan berkedudukan sebagai PURUSA, adalah : .................................................................................. .</p>
