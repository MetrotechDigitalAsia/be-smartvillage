...
<div class="mail-body" style="padding: 0 42px;" >
    ...
    <p style="text-align: justify; font-size: 12px; text-indent: 0;" >Nama Istri : <span style="text-transform: capitalize;" >{{ $field->subject_2->name ?? '' }}</span> Agama Hindu, Tempat/ tanggal lahir : <span style="text-transform: capitalize;" >{{ $field->subject_2->birthplace ?? '' }}</span>, {{ !empty($field->subject_2->birthdate) ? Carbon\Carbon::parse($field->subject_2->birthdate)->format('d/m/Y') : '' }}, Pekerjaan <span style="text-transform: capitalize;" >{{ $field->subject_2->job ?? '' }}</span>, alamat tempat tinggal di : Banjar/Lingk : {{ $field->subject_2->banjar ?? '' }} Desa {{ $field->subject_2_village ?? '' }} Kecamatan {{ $field->subject_2_district ?? '' }} Kabupaten/Kota <span style="text-transform: capitalize;" >{{ $field->subject_2_city }}</span> Provinsi <span style="text-transform: capitalize;" >{{ $field->subject_2_province }}</span>. Anak Perempuan dari: nama (ayah) <span style="text-transform: capitalize;" >{{ $field->subject_2_father_name }}</span> dan nama (ibu) <span style="text-transform: capitalize;" >{{ $field->subject_2_mother_name }}</span>  bertempat tinggal di : Banjar/Lingk : {{ $field->subject_2->banjar ?? '' }} Desa {{ $field->subject_2_village ?? '' }} Kecamatan {{ $field->subject_2_district ?? '' }} Kabupaten/Kota <span style="text-transform: capitalize;" >{{ $field->subject_2_city }}</span> Provinsi <span style="text-transform: capitalize;" >{{ $field->subject_2_province }}</span>.</p>
