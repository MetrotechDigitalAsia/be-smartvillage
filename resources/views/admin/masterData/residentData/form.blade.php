...
<form action="{{ empty($userData) ? route('storeUserData') : url('/master-data/data-penduduk/update/'.$userData->uuid) }}" method="post">
    ...
    <div class="card-body">
        ...
        @if (empty($userData))
            <div class="form-group row mt-5">
                {{-- <label class="col-xl-3 col-lg-3 col-form-label">Akun Mobile App</label> --}}
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col offset-3">
                ...
                <a href="/master-data/data-penduduk" class="btn btn-secondary mx-2">Batal</a>
