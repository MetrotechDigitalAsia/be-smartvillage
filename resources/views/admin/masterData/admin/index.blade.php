		...
		var createTable = function() {
			...
			var datatable = $('#kt_datatable').KTDatatable({
				...
				columns: [
				{
					...
					template: function(e) {
						return `\
							<a href="/master-data/admin/show/${e.id}" class="btn btn-sm btn-clean btn-icon mr-2 bg-light " title="Edit details">\
							...
							<a href="javascript:;" data-href="/master-data/admin/delete/${e.id}" onclick="deleteData(this)" class="btn btn-sm btn-clean btn-icon bg-light" title="Delete">\
