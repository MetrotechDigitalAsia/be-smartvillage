...
<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title">
            <h3 class="card-label">Perbekel & Kelian Banjar</h3>
        </div>
        <div class="card-toolbar">
            ...
            <!--begin::Button-->
            <a href="/persuratan/signature/create" class="btn btn-primary font-weight-bolder">
		...
		var createTable = function() {
			...
			var datatable = $('#kt_datatable').KTDatatable({
				...
				columns: [
				{
					...
					template: function(e) {
						return `\
							<a href="/persuratan/signature/show/${e.id}" class="btn btn-sm btn-clean btn-icon mr-2 bg-light " title="Edit">\
