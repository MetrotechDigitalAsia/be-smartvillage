...
<div class="card card-custom card-stretch">
    ...
    <div class="card-header align-items-center flex-wrap justify-content-between py-5 h-auto">
        ...
        <div class="d-flex align-items-center justify-content-end text-right my-2">
            ...
            <span class="btn btn-default btn-sm btn-icon mr-2" data-dismiss="modal">
    ...
    <div class="card-body p-0">
        ...
        <!--begin::Messages-->
        <div class="mb-3">
            <div class="cursor-pointer shadow-xs toggle-on container" data-inbox="message">
                <div class="mail-header ">
                    <img src="{{ asset('assets/be/media/desa.png') }}" alt="">
                    <h3 class="text-center m-0" >PEMERINTAH KABUPATEN BADUNG <br>KECAMATAN PETANG</h3>
                    <h2 class="m-0" >DESA GETASAN</h2>
                    <p class="m-0" >Jalan Tukad Penet No. 14 Getasan, Kec. Petang, Kab. Badung (80353)</p>
                    <p>Telp. 081 353 622 066 Website : menyusul</p>
                </div>
                <div class="mail-body">
                    <h3>SURAT KETERANGAN KELAHIRAN</h3>
                    <h6>Nomor : 045.2/33/Br.Dis/IV/2021</h6>
