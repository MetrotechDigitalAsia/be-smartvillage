    ...
    <div class="mail_2" style="border: 1px solid black; padding: 10px 30px; padding-bottom: 10px;" >
        ...
        <table style="font-size: 10px; width: 100%; font-family: sans-serif;" cellspacing="0" >
            ...
            <tr>
                ...
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" ></td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px; text-transform: uppercase;" >KAWIN</td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px; text-align: center;" ></td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" ></td>
    ...
    <div class="mail_3" style="border: 1px solid black; padding: 15px 30px; padding-bottom: 10px;" >
        ...
        <table cellspacing="0" style="font-size: 10px; width: 100%; font-family: sans-serif; margin-top: 10px;" >
            ...
            <tr>
                ...
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" ></td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" ></td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" >{{ $field->subject_1_mother_nik ?? '' }}</td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px; text-transform: uppercase;" >{{ $field->subject_1_mother_name ?? '' }}</td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" >{{ $field->subject_1_father_nik ?? '' }}</td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px; text-transform: uppercase;" >{{ $field->subject_1_father_name ?? '' }}</td>
            </tr>
            <tr>
                <td style="border: 1px solid black; height: 15px; text-align: center;" >2</td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" ></td>
                ...
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" ></td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" ></td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" >{{ $field->subject_2_mother_nik ?? '' }}</td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px; text-transform: uppercase;" >{{ $field->subject_2_mother_name ?? '' }}</td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px;" >{{ $field->subject_2_father_nik ?? '' }}</td>
                <td style="font-weight: bold; border: 1px solid black; height: 15px; text-transform: uppercase;" >{{ $field->subject_2_father_name ?? '' }}</td>
            </tr>
            @for ($i = 2; $i < 10; $i++)
            <tr>
                <td style="border: 1px solid black; height: 15px; text-align: center;" >{{ $i+1 }}</td>
