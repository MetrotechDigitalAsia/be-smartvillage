...
<body>
    ...
    <div class="mail-body" style="width: 650px; margin: inherit auto;" >
        ...
        <p style="font-size: 12px;text-align: justify; text-indent: 35px; margin-bottom: 45px;" >Pada hari ini {{  Carbon\Carbon::now()->translatedFormat('l') }}, tanggal : {{ Carbon\Carbon::now()->format('d/m/Y') }} hadir di hadapan saya : I Gede Darma, S.Pd, Bendesa Adat Getasan, Desa/Kelurahan Getasan, Kecamatan Petang, Kabupaten Badung, Provinsi Bali.</p>
