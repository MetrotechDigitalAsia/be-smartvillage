...
<body style="padding: 0 30px;" >
    ...
    <p style="margin-top: 0; text-align: justify; line-height: 22px;" >Agama {{ $field->subject_2->religion ?? '' }}, lahir di {{ $field->subject_2->birthplace ??'' }}, Tgl. {{ !empty($field->subject_2->birthdate) ? Carbon\Carbon::parse($field->subject_2->birthdate)->translatedFormat('d/m/Y') : ''}}, pekerjaan <span style="text-transform: capitalize;" >{{ $field->subject_2->job ?? '' }}</span>, bertempat tinggal di <span style="text-transform: capitalize;" >{{ $field->subject_2_banjar ?? '' }}</span>, Desa/Kelurahan {{ $field->subject_2_village ?? '' }}, Kecamatan {{ $field->subject_2_district ?? '' }}, Kabupaten/Kota <span style="text-transform: capitalize;" >{{ $field->subject_2_city }}</span>, Provinsi <span style="text-transform: capitalize;" >{{ $field->subject_2_province }}</span>, dahulu sudah/belum pernah kawin dengan -, anak perempuan dari : <span style="text-transform: capitalize;" >{{ $field->subject_2_father_name }}</span>  umur {{ $field->subject_2_father_age ?? '' }} tahun, pekerjaan <span style="text-transform: capitalize;" >{{ $field->subject_2_father_job ?? '' }}</span> dan <span style="text-transform: capitalize;" >{{ $field->subject_2_mother_name }}</span> umur {{ $field->subject_2_mother_age ?? '' }} tahun, pekerjaan <span style="text-transform: capitalize;" >{{ $field->subject_2_mother_job ?? '' }}</span>, keduanya bertempat tinggal di Banjar/Lingk : <span style="text-transform: capitalize" >{{ $field->subject_2_banjar ?? '' }}</span>, Desa/Kelurahan {{ $field->subject_2_village ?? '' }}, Kecamatan {{ $field->subject_2_district ?? '' }}, Kabupaten/Kota <span style="text-transform: capitalize;" >{{ $field->subject_2_city }}</span>, Provinsi <span style="text-transform: capitalize;" >{{ $field->subject_2_province }}</span>.</p>
