<div class="card card-custom">
    ...
    <div class="card-header flex-wrap border-0 pt-6 pb-0">
        <div class="card-title flex-grow-1">
            <h3 class="card-label">Semua Surat</h3>
            ...
            var datatable = $('#kt_datatable').KTDatatable({
                ...
                columns: [
                {
                    ...
                    template: function(e) {
                        ...
                        switch (e.status) {
                            case 'Pending':
                                return `<span class="label label-light-warning label-pill label-inline label-lg">${e.status}</span>`
                                break;
                            case 'Rejected':
                                return `<span class="label label-light-danger label-pill label-inline label-lg">Ditolak</span>`
                                break;
                            case 'Done':
                                return `<span class="label label-light-success label-pill label-inline label-lg">Selesai</span>`
                                break;
                            default:
                                return `<span class="label label-light-info label-pill label-inline label-lg">Diproses</span>`
                                break;
                        }
